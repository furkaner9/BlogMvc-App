...
namespace BlogMvcApp.Controllers
{
    public class BlogController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Baslık,Acıklama,Icerik,EklemeTarihi,Onay,Anasayfa,CategoryId")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Baslık,Acıklama,Icerik,EklemeTarihi,Onay,Anasayfa,CategoryId")] Blog blog)
        {
            if (ModelState.IsValid)
            {
